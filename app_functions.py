...
def print_question(die_1_value, die_2_value, question_type):
    ...
    if question_type == "sum":
        print("You rolled a {0} and a {1}... What is the sum of {0} and {1}?".format(die_1_value, die_2_value))
    elif question_type == "difference":
        print("You rolled a {0} and a {1}... What is the difference between {0} and {1}?".format(die_1_value, die_2_value))
